...
class ShotRecord {
public:
	__forceinline ShotRecord() : m_target{}, m_record{}, m_time{}, m_lat{}, m_damage{}, m_pos{}, m_aim{}, m_matched{} {}
...
public:
	...
	void OnShotFire(Player* target, float damage, int bullets, LagRecord* record, vec3_t m_pos = vec3_t{});

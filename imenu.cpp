...
void Hooks::Aimbot( ) {
	...
	ImGui::Columns( 2, NULL, false );
	{
		...
		InsertGroupBoxLeft( XOR( "Aimbot" ), 287.f );
		{
			...
			InsertCheckbox( XOR( "Rapid fire" ), b[ XOR( "rapidfire" ) ] );
...
void Hooks::imgui_menu( ) {
	...
	ImGui::BeginMenuBackground( XOR( "jre.rest" ), &g_hooks.Is_Open, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoNavFocus | ImGuiWindowFlags_NoNavInputs | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoTitleBar );
	{
